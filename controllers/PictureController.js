...
//Função para excluir a imagem do Banco
...
exports.delete = async (req, res) => {
  try {
    ...
    // Tenta encontrar e excluir a imagem pelo ID
    const picture = await Picture.findByIdAndDelete(pictureId);

    // Se não encontrar a imagem, retorna um erro
    if (!picture) {
    ...
    // Caso tenha erro, retorna uma mensagem de erro
