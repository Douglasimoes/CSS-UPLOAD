...
async function main() {
  await mongoose.connect(
    // Link do Mongo
    `mongodb+srv://${dbUser}:${dbPassword}@clusterapi.inbse.mongodb.net/?retryWrites=true&w=majority&appName=ClusterAPI`
  );
...
//mongodb+srv://douglasskt:<db_password>@clusterapi.inbse.mongodb.net/?retryWrites=true&w=majority&appName=ClusterAPI